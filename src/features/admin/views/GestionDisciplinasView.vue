  ...
  <div class="gestion-disciplinas">
    ...
    <div class="filters-bar">
      <div class="search-box">
        ...
        <input v-model="busqueda" type="text" placeholder="Buscar disciplina por nombre..." class="search-input" />
      </div>
            ...
            <tr v-for="disciplina in disciplinasFiltradas" :key="disciplina.id">
              ...
              <td class="actions-column">
                <div class="action-buttons">
                  <button @click="editar(disciplina)" class="btn-action btn-edit" title="Editar disciplina">
                    <i class="pi pi-pen-to-square" style="color: gray; font-size: 1.1rem;"></i>
                  </button>
                  <button @click="toggleEstado(disciplina)"
                  ...
                  <button @click="confirmarEliminar(disciplina)" class="btn-action btn-delete"
      ...
      <div v-if="mostrarModal" class="modal-overlay" @click.self="cerrarModal">
        <div class="modal-content">
          <div class="modal-header">
            <h3> <i class="pi pi-objects-column" style="color: orange; font-size: 1rem;"></i> {{ modoEdicion ? 'Editar'
              : 'Nueva' }}
              Disciplina</h3>
          ...
          <form @submit.prevent="guardar" class="modal-body">
            <div class="form-group">
              ...
              <input v-model="form.nombre" type="text" class="form-input" placeholder="Ej: Fútbol, Natación, Tenis..."
            ...
            <div class="form-group">
              ...
              <textarea v-model="form.descripcion" rows="4" class="form-textarea"
                placeholder="Describe la disciplina deportiva..." maxlength="500"></textarea>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn-primary" :disabled="guardando">
                <i :class="modoEdicion ? 'pi pi-save' : 'pi pi-plus'" style="color: whitesmoke;">
                </i>
    ...
    <Transition name="modal">
      <div v-if="mostrarConfirmacion" class="modal-overlay" @click.self="mostrarConfirmacion = false">
        <div class="modal-content modal-confirm">
          ...
          <p>Esta acción no se puede deshacer. La disciplina "{{ disciplinaAEliminar?.nombre }}" será eliminada
            permanentemente.</p>
