  ...
  <body class="bg-[#0a0f1a]">
    ...
    <div class="min-h-screen bg-[#0a0f1a] pb-12">
      ...
      <div class="hero-section relative overflow-hidden">
        <div
          class="hero-overlay absolute inset-0 bg-gradient-to-red from-[#0a0f1a]/95 via-blue-900/80 to-transparent z-10">
        </div>


        <!-- Carrusel de imágenes -->
        <div class="hero-carousel absolute inset-0">
          <div v-for="(imagen, index) in imagenesHero" :key="index"
        ...
        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-30 flex gap-2">
          <button v-for="(_, index) in imagenesHero" :key="index" @click="cambiarImagen(index)"
            class="carousel-indicator" :class="{ active: index === imagenActual }"></button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div class="glass-card cursor-pointer" @click="verDisciplinas">
            <div class="card-content">
              ...
              <Button label="Abrir" icon="pi pi-arrow-right" text class="text-blue-400 hover:text-blue-300" />
            </div>
          </div>
          ...
          <div class="glass-card cursor-pointer" @click="explorarCursos">
            <div class="card-content">
              ...
              <Button label="Abrir" icon="pi pi-arrow-right" text class="text-purple-400 hover:text-purple-300" />
            </div>
          </div>
          ...
          <div class="glass-card cursor-pointer" @click="gestionarReservas">
            <div class="card-content">
              ...
              <Button label="Abrir" icon="pi pi-arrow-right" text class="text-green-400 hover:text-green-300" />
            </div>
          </div>
        </div>
